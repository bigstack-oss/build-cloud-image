...
#sudo virt-customize --run-command "echo 'exclude=kernel*' >> /etc/yum.conf" -a ./images/CentOS-7.qcow2
...
#echo "------ disable kernel auto update ------"
#sudo virt-customize --run-command "echo 'exclude=kernel*' >> /etc/yum.conf" -a ./images/CentOS-Stream-8.qcow2
...
echo "------ disable kernel auto update ------"
sudo virt-customize --run-command "echo 'exclude=kernel*' >> /etc/yum.conf" -a ./images/CentOS-Stream-9.qcow2
