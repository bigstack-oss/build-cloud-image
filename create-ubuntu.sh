...
sudo virt-copy-in './config/ubuntu/20auto-upgrades' /etc/apt/apt.conf.d/ -a ./images/ubuntu2004.qcow2
echo "------ prepare disk ------"
...
echo "------ disable kernel auto update ------"
sudo virt-copy-in './config/ubuntu/20auto-upgrades' /etc/apt/apt.conf.d/ -a ./images/ubuntu2204.qcow2
...
sudo virt-copy-in './config/daemon.json' /etc/docker/ -a ./images/ubuntu2404.qcow2
echo "------ disable kernel auto update ------"
sudo virt-copy-in './config/ubuntu/20auto-upgrades' /etc/apt/apt.conf.d/ -a ./images/ubuntu2404.qcow2
