...
sudo virt-copy-in "./nchc/rhel/centos-addons.repo" /etc/yum.repos.d/ -a ./images/CentOS-Stream-9-nchc.qcow2
cp ./nchc/rhel/centos.repo-c9 ./nchc/rhel/centos.repo
sudo virt-copy-in "./nchc/rhel/centos.repo" /etc/yum.repos.d/ -a ./images/CentOS-Stream-9-nchc.qcow2
echo "------ prepare disk ------"
